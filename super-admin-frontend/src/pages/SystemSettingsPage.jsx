    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="general" className="space-y-6">
        ...
        <TabsContent value="general" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Input id="app-name" defaultValue="SaaS Platform" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="app-description">Description</Label>
                  <Textarea id="app-description" defaultValue="Multi-tenant SaaS platform for enterprise solutions" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="app-url">Primary URL</Label>
                  <Input id="app-url" defaultValue="https://platform.example.com" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="timezone">Default Timezone</Label>
                  <Select onValueChange={() => handleInputChange()}>
                    <SelectTrigger><SelectValue placeholder="UTC" /></SelectTrigger>
                    <SelectContent>
          ...
          <Card>
            <CardHeader><CardTitle>System Limits & Quotas</CardTitle></CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                  <Label htmlFor="max-tenants">Max Tenants</Label>
                  <Input id="max-tenants" type="number" defaultValue="1000" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="max-users-per-tenant">Max Users per Tenant</Label>
                  <Input id="max-users-per-tenant" type="number" defaultValue="10000" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="max-storage">Max Storage per Tenant (GB)</Label>
                  <Input id="max-storage" type="number" defaultValue="1000" onChange={handleInputChange} />
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input id="session-timeout" type="number" defaultValue="60" onChange={handleInputChange} />
                </div>
                <div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input id="max-login-attempts" type="number" defaultValue="5" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="lockout-duration">Lockout Duration (minutes)</Label>
                  <Input id="lockout-duration" type="number" defaultValue="15" onChange={handleInputChange} />
                </div>
              </CardContent>
            </Card>
          </div>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="smtp-host" defaultValue="smtp.example.com" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="smtp-port">SMTP Port</Label>
                  <Input id="smtp-port" type="number" defaultValue="587" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="smtp-username">Username</Label>
                  <Input id="smtp-username" defaultValue="noreply@example.com" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="smtp-password">Password</Label>
                  <Input id="smtp-password" type="password" placeholder="••••••••" onChange={handleInputChange} />
                </div>
              </div>
              <div className="flex items-center justify-between">
                <div>
              ...
              <div>
                ...
                <Input id="from-address" defaultValue="noreply@platform.example.com" onChange={handleInputChange} />
              </div>
              <div>
                <Label htmlFor="from-name">Default From Name</Label>
                <Input id="from-name" defaultValue="SaaS Platform" onChange={handleInputChange} />
              </div>
              <div className="pt-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <Input id="notification-email" type="email" defaultValue="admin@example.com" onChange={handleInputChange} />
              </div>
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="api" className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input id="api-rate-limit" type="number" defaultValue="1000" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="api-version">Default API Version</Label>
                  <Select onValueChange={() => handleInputChange()}>
                    <SelectTrigger><SelectValue placeholder="v1" /></SelectTrigger>
                    <SelectContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <Input id="webhook-timeout" type="number" defaultValue="30" onChange={handleInputChange} />
                </div>
                <div>
                  <Label htmlFor="webhook-retry-attempts">Max Retry Attempts</Label>
                  <Input id="webhook-retry-attempts" type="number" defaultValue="3" onChange={handleInputChange} />
                </div>
                <div className="flex items-center justify-between">
                  <div>
          ...
          <Card>
            <CardHeader><CardTitle>System API Keys</CardTitle></CardHeader>
            <CardContent>
