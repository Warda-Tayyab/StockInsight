    ...
    <div className="space-y-6">
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will suspend the tenant account. Users will lose access immediately. 
                    Are you sure you want to proceed?
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Cancel</AlertDialogCancel>
                  <AlertDialogAction onClick={handleSuspendTenant}>
                    Suspend Tenant
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
            ...
            <AlertDialog>
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will reactivate the tenant account. Users will regain access immediately. 
                    Are you sure you want to proceed?
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel>Cancel</AlertDialogCancel>
                  <AlertDialogAction onClick={handleReactivateTenant}>
                    Reactivate Tenant
                  </AlertDialogAction>
                </AlertDialogFooter>
              </AlertDialogContent>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">
              Limit: {tenant.quotas?.storageGB || 0}GB
            </p>
          </CardContent>
        </Card>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        <TabsList>
          ...
          <TabsTrigger value="email-to-ticket">Email → Ticket</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="quotas" className="space-y-4">
          <QuotasTab tenant={tenant} stats={stats} />
        </TabsContent>
